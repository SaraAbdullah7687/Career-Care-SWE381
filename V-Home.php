            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                  <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="postedJobsV.html">JOBS</a>
                      </li>
                    <li class="nav-item">
                        <a class="nav-link" href="Search (V).html">SEARCH</a>
                      </li>
                    <li class="nav-item">
                      <div class="dropdown">
                        <a class="nav-link dropbtn" >SIGN IN</a>
                        <div class="dropdown-content" >
                          <a class="nav-link" href="Web/Login_v4/login-e.php"> Employer</a>
                          <a class="nav-link" href="Web/Login_v4/login-j.php"> Job Seeker</a>
                        </div>
                      </div>              
                          </li>
                    <li class="nav-item">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-content" >
                          <a class="nav-link" href="Web/Login_v4/SignUpE.php"> Employer</a>
                          <a class="nav-link" href="Web/Login_v4/SignUpJS.php"> Job Seeker</a>
                        </div>
                      </div>              
                          </li>
                          <li >
