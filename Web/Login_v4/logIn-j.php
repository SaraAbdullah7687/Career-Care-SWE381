<?php 
    ...
    if(isset($_SESSION['user-j']))
        // header() is used to send a raw HTTP header. It must be called before any actual output is sent.

        header("Location: ../../J-Home.php"); // NEED to be fixed > it is outside the folder (DONE fixing)
	...
	<div class="limiter">
		...
		background: linear-gradient(0deg, rgba(76,81,109,1) 0%, rgba(133,177,179,1) 82%);
			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				<form class="login100-form validate-form" action="checklogin-j.php" method="post">
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Email is reauired">
						...
						<input class="input100" type="text" name="user-j" placeholder="Type your Email">
						<span class="focus-input100" data-symbol="&#xf206;"></span>
					</div>

					<div class="wrap-input100 validate-input" data-validate="Password is required">
						<span class="label-input100">Password</span>
						<input class="input100" type="password" name="pass-j" placeholder="Type your password">
						<span class="focus-input100" data-symbol="&#xf190;"></span>
					</div>
