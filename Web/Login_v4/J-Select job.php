    ...
    <div class="limiter">
        ...
        background: linear-gradient(0deg, rgba(76,81,109,1) 0%, rgba(133,177,179,1) 82%);
            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54" style="width: 32.5%; min-height: 500px">
                <form class="login100-form validate-form" method="GET" id="j-sjForm" action="J-interview.php" style="width: 100%;" >
                    ...
                    <div class="input100 validate-input" style="margin-bottom: 30%">
                        <select name="j-jobChoice" id="j-jobChoice" style="  width: 99% !important; border: none; border-radius: 2px; margin-left: -20px;">
                            <option value=""> Jobs </option>
                            <?php
                                                                
                                $e =  $_SESSION['j_email']; 

                                $query= "SELECT * FROM `applicants`,`job` WHERE `j_email` = '$e' AND `applicants`.`job_ID`=`job`.`jobID` AND `applicants`.`accepted`='1' "; 
                    ...
                    <div class="container-login100-form-btn" style="width: 100%; ">
                        <div class="wrap-login100-form-btn">
                            ...
                            <button type="submit" style="text-align: center; width: 100%;" name="j-Selectj" ><a style="color: white;" class="login100-form-btn" >
                                Select
                            </a></button>
