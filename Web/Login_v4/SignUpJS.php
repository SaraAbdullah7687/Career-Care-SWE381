    ...
    <div class="limiter">
        <div class="container-login100" style="background: rgb(76,81,109); background: linear-gradient(0deg, rgba(76,81,109,1) 0%, rgba(133,177,179,1) 82%);">
            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" method="post" action="SignUpJSprocess.php" id="SignUPJS">
                    <span class="login100-form-title p-b-49">
                        SIGN UP
                        <div class="title">
                            <p>User type: <span> Job Seeker </span> </p>
                        </div>
                    </span>

                    <div class="wrap-input100 validate-input m-b-23" data-validate="Reauired Feild">
                        <span class="label-input100">First Name</span>
                        <input class="input100" type="text" name="fName" id="form_fname">
                        <span class="focus-input100" id="fname_error_message"></span>
                    </div>
                    <div class="wrap-input100 validate-input m-b-23" data-validate="Reauired Feild">
                        <span class="label-input100">Last Name</span>
                        <input class="input100" type="text" name="lName" id="form_lname">
                    ...
                    <div class="wrap-input100 validate-input m-b-23" data-validate="Reauired Feild">
                        ...
                        <input class="input100" type="date" max="2003-12-31" min="1970-01-01" name="birthdate" id="form_birthdate">
                        <span class="focus-input100" id="date_error_message"></span>
                    </div>
                    <div class="wrap-input100 validate-input m-b-23" data-validate="Reauired Feild">
                        <span class="label-input100">Nationality</span>
                        <input class="input100" type="text" name="nationality" id="form_empty">
                        <span class="focus-input100" id="empty_error_message"></span>
                    </div>
                    <div class="wrap-input100 validate-input m-b-23" data-validate="Reauired Feild">
                        <span class="label-input100">City</span>
                        <input class="input100" type="text" name="city" id="form_empty1">
