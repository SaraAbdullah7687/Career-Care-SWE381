...
?><!--===============================================================================================--> <?php
                        ...
                        if($_GET['RadioGroup1']=="Employer"){
                            ...
                            while($row = $result->fetch_assoc()): {
                                ...
                                $eemail= $row['e_email']; 
                                $sql2 = "SELECT `jobID` FROM `job` WHERE '$eemail' = `job`.`e-email`; "; 
                                if ($result2 = mysqli_query( $conn, $sql2 )){
                                  $jdresult = $result2->fetch_assoc(); 
                                  $jid= $jdresult['jobID']; 
                                } else echo "no name ";
                                ...
                                <div class="center-btn "> <form method="post" action="ProfileER.php"><!---->
                                    <input type="hidden" name="viewEmpProfile" value="<?php echo $jid;  ?>"> 
...
?><!--===============================================================================================--><?php
                        ...
                        if($_GET['RadioGroup1']=="Job"){
                            ...
                            while($row = $result->fetch_assoc()): 
                                ...
                                $eemail= $row['e-email']; 
                                $jid= $row['jobID']; 
                                $sql2 = "SELECT `company_name` FROM `employer` WHERE '$eemail' = `employer`.`e_email`; "; 
                                if ($result2 = mysqli_query( $conn, $sql2 )){
                                ...
                                <div class="job-details" style="height: 90% ; overflow: hidden; ">
                                  ...
                                  <p><form method="post" action="ProfileER.php"><!---->
                                    <input type="hidden" name="viewEmpProfile" value="<?php echo $jid;  ?>"><button style="background-color: transparent; border: none;"> <a style="color:black; text-decoration: none;"><?php echo $ename ?></a> </button></form> </p>
                              ...
                              <div class="apply-btn">
                                    ...
                                    <button  class="btn btn-primary" style="right: 120px">Read More</button> </form>
                                    <a  href="PHP/apply.php?apply=<?php echo $row['jobID']; ?>&applicant=<?php echo $_SESSION['j_email']; ?>&page=search"><button class="btn btn-primary">Apply</button></a>
                              </div>
                          </div>
